...
public class SubjectActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout ll_home_subject;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case REQUEST_FAILURE:
                    ...
                    ll_home_subject.setVisibility(View.GONE);
                    ll_no_network.setVisibility(View.VISIBLE);

                    break;
                case REQUEST_SUCCESS:
                    //原页面GONE掉，提示网络不好的页面出现
                    ll_home_subject.setVisibility(View.VISIBLE);
...
//                    mViewPager.setOffscreenPageLimit(subjectClassifyListBean.size());
    ...
    protected void initView() {
        ll_home_subject = (LinearLayout) findViewById(R.id.ll_home_subject);
...
//            ClinicalFragment.ISREFRESHDATA = 0;
//            initData();
//            selectTab(0);
//        }
//    }
    ...
    private void initTabColumn() {
        ...
        int count = subjectClassifyListBean.size();
        mColumnHorizontalScrollView.setParam(this, mScreenWidth, mRadioGroup_content, shade_left, shade_right, ll_more_columns, rl_column);
        for (int i = 0; i < count; i++) {
            int dp10 = (int) getResources().getDimension(R.dimen.dp16);
            int dp16 = (int) getResources().getDimension(R.dimen.dp32);
...
//            columnTextView.setPadding(5, 5, 5, 5);
            ...
            columnTextView.setText(subjectClassifyListBean.get(i).catename);
    ...
    private void initFragment() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            data.putString("cateid", subjectClassifyListBean.get(i).cateid);
            homeSubjectFragment = new HomeSubjectFragment();
            homeSubjectFragment.setArguments(data);
            fragments.add(homeSubjectFragment);
        }
    ...
    private void getAllSubjectClassifyList() {
        NetApi.getAllSubjectClassifyList(new PasserbyClient.HttpCallback() {
            ...
            public void onSuccess(String result) {
                LogUtil.e("getAllSubjectClassifyList:" + result);
                if (!HttpCodeJugementUtil.HttpCodeJugementUtil(result, SubjectActivity.this)) {
                    return;
                }
