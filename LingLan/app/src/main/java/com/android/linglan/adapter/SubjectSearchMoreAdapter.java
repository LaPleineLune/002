 ...
 */
public class SubjectSearchMoreAdapter extends
        RecyclerView.Adapter{
    private Context context;
    public ArrayList<com.android.linglan.http.bean.RecommendSubjects.RecommendSubject> RecommendSubjects;
    ...
    public SubjectSearchMoreAdapter(Context context) {
