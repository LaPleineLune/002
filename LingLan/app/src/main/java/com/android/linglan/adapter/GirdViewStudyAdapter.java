 ...
 */
public class GirdViewStudyAdapter extends BaseAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    public boolean edit = false;
    public ArrayList<RecommendSubjects.RecommendSubject> recommendSubject;

    public GirdViewStudyAdapter(Context context) {
        this.context = context;
        layoutInflater = LayoutInflater.from(context);
    }
    @Override
    public int getCount() {
        return this.recommendSubject != null ? this.recommendSubject.size() : 4 ;
    }
