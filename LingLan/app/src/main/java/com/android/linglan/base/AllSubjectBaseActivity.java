 ...
 */
public abstract class AllSubjectBaseActivity extends FragmentActivity implements View.OnClickListener {//AppCompatActivity
    private String tag = getClass().getSimpleName();
    private static List<AllSubjectBaseActivity> childlist;
    protected TextView title;
    protected RelativeLayout back;
    protected ImageView right,order;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setListener();
        if (childlist == null) {
            childlist = new ArrayList<AllSubjectBaseActivity>();
        }
        childlist.add(this);
    }
