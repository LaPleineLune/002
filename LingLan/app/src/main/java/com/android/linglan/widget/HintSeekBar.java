...
import com.android.linglan.utils.CommonUtils;
...
//    private TextView mPopupTextView;// my
...
//        mPopupTextView = (TextView) undoView.findViewById(R.id.tv_content);// my
//        mPopupTextView.setText(popupText != null ? popupText : String.valueOf(getProgress()));// my
...
//        mPopupTextView.setText(popupText != null ? popupText : String.valueOf(progress));// my

//        if (mPopupStyle == POPUP_FOLLOW) {
//            mPopup.update((int) (this.getX() + (int) getXPosition(seekBar)), (int) (this.getY() + mYLocationOffset + this.getHeight()), -1, -1);
//        }
//        View popupView = mPopup.getContentView();// my
//        if (mPopupStyle == POPUP_FOLLOW) {// my
