  ...
  @Override
	...
	private class Attributes
	{
      ...
      Resources resources = context.getResources();
			...
			this.cancelButtonBackground = new ColorDrawable(Color.TRANSPARENT);
/*			ColorDrawable gray = new ColorDrawable(Color.GRAY);
      ...
      this.cancelButtonBackground = resources.getDrawable(R.drawable.actionsheet_slt_as_ios7_cancel_bt);
      this.otherButtonTopBackground = resources.getDrawable(R.drawable.actionsheet_slt_as_ios7_other_bt_top);
      this.otherButtonMiddleBackground = resources.getDrawable(R.drawable.actionsheet_slt_as_ios7_other_bt_middle);
      this.otherButtonBottomBackground = resources.getDrawable(R.drawable.actionsheet_slt_as_ios7_other_bt_bottom);
      this.otherButtonSingleBackground = resources.getDrawable(R.drawable.actionsheet_slt_as_ios7_other_bt_single);
